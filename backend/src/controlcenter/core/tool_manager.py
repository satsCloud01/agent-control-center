...
class ToolManager:
    ...
    def _register_builtin_tools(self):
        from controlcenter.tools.web_search import create_web_search_tool
        from controlcenter.tools.code_executor import create_code_executor_tool
        from controlcenter.tools.file_io import create_file_io_tools
        from controlcenter.tools.api_caller import create_api_caller_tool
